...
![License](https://img.shields.io/github/license/chffhc/IP-Sentinel)
...
```bash
curl -fsSL https://raw.githubusercontent.com/chffhc/IP-Sentinel/main/master/install_master.sh -o /tmp/ins_master.sh && sudo bash /tmp/ins_master.sh
```
...
```Bash
curl -fsSL https://raw.githubusercontent.com/chffhc/IP-Sentinel/main/core/install.sh -o /tmp/ins_agent.sh && sudo bash /tmp/ins_agent.sh
```
...
```bash
bash <(curl -sL https://raw.githubusercontent.com/chffhc/IP-Sentinel/legacy/core/install.sh)
```
...
<a href="https://github.com/chffhc/IP-Sentinel/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=chffhc/IP-Sentinel" alt="Contributors" />
</a>
...
[![Stargazers over time](https://starchart.cc/chffhc/IP-Sentinel.svg?variant=adaptive)](https://starchart.cc/chffhc/IP-Sentinel)